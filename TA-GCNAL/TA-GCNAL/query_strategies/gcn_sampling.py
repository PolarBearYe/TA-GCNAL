...
class GCNSampling(CoreSet):
    ...
    def query(self, n):
        ...
        idxs_all_unlabeledx1 = np.random.choice(idxs_all_unlabeled,min(self.subset_size, min(self.subset_size, len(idxs_all_unlabeled))), replace=False)
        gcn_model, optim_gcn, feat, features,idxs_fenxun1 = GCNSampling.fenxun(self, idxs_all_unlabeledx1,embeds)
        del gcn_model, optim_gcn, feat, features
        #idxs_fenxun = idxs_fenxun1
        idxs_fenxun = idxs_fenxun1

        torch.cuda.empty_cache()

        return idxs_fenxun, None, None, None, None, None
    def fenxun(self,idxs_unlabeled,embeds,fen):
        ...
        return gcn_model, optim_gcn, feat, features,idxs_unlabeled[chosen]
